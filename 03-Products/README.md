...
- **QuEra** — 中性原子量子计算与传感
- **PsiQuantum** — 光量子计算
- **Q-CTRL** — 量子控制软件平台（Fire Opal、Boulder Opal 等）
- **本源量子** — 中国量子计算公司
...
- [IonQ Cloud](https://ionq.com/cloud) - 云端访问

**产品线：**
- **IonQ Tempo** - 最新商用离子阱量子计算机
- **IonQ Forte Enterprise** - 企业级量子计算系统
- **IonQ Forte** - 高性能量子计算设备
- **IonQ Aria** - 中型量子处理器，25+ 量子比特
- **IonQ Harmony** - 早期量子处理器

**核心技术参数：**
- 量子比特类型：电离镱原子（Yb+）
- 囚禁方式：线性离子阱，约100个微型电极
- 连接性：全连接架构（任意量子比特可直接交互）
- 保真度：世界纪录级量子门保真度（99.99%+）
- 离子链规模：单量子比特门在 79 离子链上运行
- 特色：长相干时间、完全连接性
...
- [Q-CTRL 技术博客](https://www.q-ctrl.com/blog) - 技术博客和白皮书

**产品线（Opal 平台）：**
- **Black Opal** - 量子计算教育工具，帮助初学者学习量子技术
- **Fire Opal** - 自动减少量子计算机错误的软件，提升算法成功率
- **Boulder Opal** - 专业级量子控制工具包，设计和扩展量子硬件
...
**主要产品：**
- **Sqale 量子计算机** - 全栈、容错的中性原子量子计算机
- **Tiqker 原子钟** - 下一代光学原子钟
- **量子射频接收器** - 基于里德堡原子传感的频谱感知技术
- **惯性传感** - GPS 拒止环境中的精密定位

**技术特点：**
- 可扩展至数百万量子比特
- 量子计算路线图：2028 年超过 100 个逻辑量子比特
- 先进纠错平台：双物种原子阵列与低串扰测量
- 集成光子学技术（激光系统嵌入光子集成电路）

#### Quantinuum（离子阱量子计算）
- [Quantinuum 技术官网](https://www.quantinuum.com/technology) - H 系列离子阱量子计算机
- [Quantinuum 新闻](https://www.quantinuum.com/news) - 公司新闻和最新动态

**最新动态（2026）：**
- 与 BMW 集团扩大合作，签署多年期协议
- 秘密提交 IPO 文件（2026年4月）
- 日本 RIKEN 通过 Quantinuum 系统升级扩展量子超级计算能力
- 在新加坡设立新的研发中心
...
| 公司 | 技术路线 | 官网 |
|------|---------|------|
| Pasqal | 中性原子 | [pasqal.com](https://www.pasqal.com) |
| QuEra | 中性原子 | [quera.com](https://www.quera.com) |
| PsiQuantum | 光量子 | [psiquantum.com](https://www.psiquantum.com) |
| 本源量子 | 超导/离子阱 | [originqc.com.cn](https://originqc.com.cn) |
| 百度量子 | 超导 | [quantum.baidu.com](https://quantum.baidu.com) |
| 华为量子 | 超导 | [huawei.com/quantum](https://www.huawei.com) |
...
- **量子加密标准**：NIST 后量子密码学标准即将发布
- **量子计算机时间表**：IBM 预计 2033 年实现量子优势
- **投资热潮**：全球量子计算投资持续增长
- **量子云服务**：主要云服务商全面布局量子计算即服务（QaaS）
